...
ASIO_INSTALL_DIR=$CRT_DIR"/third_party/asio"
GRPC_INSTALL_DIR=$CRT_DIR"/third_party/grpc"
...
ASIO_DIR=$CRT_DIR"/pkg_third_party/asio-1.24.0"
GRPC_DIR=$CRT_DIR"/pkg_third_party/grpc"
GF_DIR=$CRT_DIR"/pkg_third_party/gf-complete"
JERASURE_DIR=$CRT_DIR"/pkg_third_party/jerasure"
LIBMEMCACHED_DIR=$CRT_DIR"/pkg_third_party/libmemcached-1.0.18"
MEMCACHED_DIR=$CRT_DIR"/pkg_third_party/memcached-1.6.17"
PYBIND_PACKAGES_DIR=$CRT_DIR"/pkg_third_party/pybind11-2.10.4"

PACKAGES_DIR=$CRT_DIR"/pkg_third_party"
...
# rm -r -f $GF_DIR
# rm -r -f $JERASURE_DIR
# rm -r -f $LIBMEMCACHED_DIR
# rm -r -f $MEMCACHED_DIR
...
rm -r -f $CRT_DIR"/pkg_third_party"